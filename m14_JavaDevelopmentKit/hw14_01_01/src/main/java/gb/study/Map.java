...
public class Map extends JPanel {
    ...
    /**
     * Метод обновления/отрисовки карты после нажатия мыши
     ...
     * @return true - конец, false - еще нет
     */
    ...
    /**
     * Запускает новую игру/карту с настроенными характеристиками
    ...
    /**
     * Показ сообщения с результатами игры
     */
    ...
    //todo переделать логику проверки
