...
https://github.com/DavidZolotoi/GB_GH/tree/main/m16_SpringFramework/hw16_01_01
...
https://github.com/DavidZolotoi/GB_GH/tree/main/m16_SpringFramework/hw16_02_01/empl4sem2CRUD/src/main/java/com/example/empl4sem2CRUD
...
а) создается пользователь из параметров метода,
б) созданный пользователь добавляется в репозиторий,
в) через notificationService выводится сообщение в консоль.
...
=========================
https://github.com/DavidZolotoi/GB_GH/tree/main/m16_SpringFramework/hw16_03_01/Seminar3/example3sem3hometask/src/main/java/ru/geekbrain/example3sem3hometask (есть файл с результатом работы, который можно скачать: https://github.com/DavidZolotoi/GB_GH/blob/main/m16_SpringFramework/hw16_03_01/Seminar3/result.rtf)
...
https://github.com/DavidZolotoi/GB_GH/tree/main/m16_SpringFramework/hw16_04_01/src/main
...
1. ID (автоинкрементное)(тип Long).
2. Описание (не может быть пустым)(тип String).
3. Статус (одно из значений: "не начата", "в процессе", "завершена")(Тип TaskStatus ).
4. Дата создания (автоматически устанавливается при создании задачи)(Тип LocalDateTime).
Подсказка понадобится энумератор: 
enum TaskStatus { 
NOT_STARTED, IN_PROGRESS, COMPLETED; 
}
https://github.com/DavidZolotoi/GB_GH/tree/main/m16_SpringFramework/hw16_05_01
...
Структура заметки:
1. ID (автоинкрементное)(тип - Long).
2. Заголовок (не может быть пустым)(тип - String).
3. Содержимое (не может быть пустым)(тип - String).
4. Дата создания (автоматически устанавливается при создании заметки)(тип - LocalDateTime).
Подсказка:
...
https://github.com/DavidZolotoi/GB_GH/tree/main/m16_SpringFramework/hw16_06_01/src/main/java/gb/study/hw16_06_01
...
```
https://github.com/DavidZolotoi/GB_GH/tree/main/m16_SpringFramework/hw16_07_01/src/main

### Урок 8. Spring AOP, управление транзакциями.
- Выполнить для одного из пройденных семинаров в проекте с Базой Данных.
...
https://github.com/DavidZolotoi/GB_GH/tree/main/m16_SpringFramework/hw16_08_01/src/main/java/gb/study/hw16_08_01
...
https://github.com/DavidZolotoi/GB_GH/tree/main/m16_SpringFramework/hw16_09_01
...
https://github.com/DavidZolotoi/GB_GH/tree/main/m16_SpringFramework/hw16_10_01/src/test/java/gb/study/hw16_10_01/service/implmnt
...
https://github.com/DavidZolotoi/GB_GH/tree/main/m16_SpringFramework/hw16_11_01
...
https://github.com/DavidZolotoi/GB_GH/tree/main/m16_SpringFramework/hw16_12_01/src/main/java/gb/study/hw16_12_01